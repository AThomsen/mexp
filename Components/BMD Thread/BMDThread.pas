...
Small patch by Anders Thomsen in Destroy method. January 02. 2011   
...
V1.61		      01/28/2009		Added missing D2006 and D2005 project files.
V1.7		      09/14/2009		Delphi 2010 support added.
V1.71		      09/20/2009		Fixed D2006 package.

Legal issues: Copyright (C) 1999 - 2009 by Boian Mitov
              mitov@mitov.com
              www.mitov.com
              www.openwire.org
...
begin
  ...
  begin
    ...
    begin
      // Change by Anders Thomsen, jan 2011:
      // Call CheckSynchronize instead of ProcessMessages. 
