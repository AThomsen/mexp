...
//  TJvMPEGModeExtension = (meModeExt0, meModeExt1, meModeExt2, meModeExt3);
  ...
  TMyID3ControllerOption = (coAutoCorrect, coRemoveEmptyFrames);
  TMyID3ControllerOptions = set of TMyID3ControllerOption;
  ...
  public
    ...
    { SourceEncoding =
        ...
        - When writing: encoding of current frame in the TMyID3Controller }
    property SourceEncoding: TJvID3Encoding read FSourceEncoding write SetSourceEncoding;
    { DestEncoding =
        - When reading: encoding of current frame in the TMyID3Controller
  ...
  public
    constructor Create(AController: TMyID3Controller); virtual;
    procedure AfterConstruction; override;
    procedure ChangeToVersion(const ANewVersion: TJvID3Version); virtual; abstract;
    procedure Assign(Source: TPersistent); override;
    property Controller: TMyID3Controller read FController;
  end;
  ...
  private
    ...
    function GetStream: TJvID3Stream;
    procedure SetController(const AController: TMyID3Controller);
  ...
  public
    ...
    class function CanAddFrame(AController: TMyID3Controller; AFrameID: TJvID3FrameID): Boolean; virtual;
    function CheckFrame(const HandleError: TJvID3HandleError): Boolean; virtual;

    procedure Assign(Source: TPersistent); override;
    procedure Clear; virtual;
    property Controller: TMyID3Controller read FController write SetController stored False;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3BinaryFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3BinaryFrame;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3DoubleListFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3DoubleListFrame;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3ContentFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3ContentFrame;
  published
  ...
  public
    ...
    class function Find(AController: TMyID3Controller): TJvID3GeneralObjFrame; overload;
    class function Find(AController: TMyID3Controller; const AContentDescription: WideString): TJvID3GeneralObjFrame; overload;
    class function FindOrCreate(AController: TMyID3Controller): TJvID3GeneralObjFrame; overload;
    class function FindOrCreate(AController: TMyID3Controller; const AContentDescription: WideString): TJvID3GeneralObjFrame; overload;
  published
  ...
  public
    ...
    class function Find(AController: TMyID3Controller): TJvID3PopularimeterFrame; overload;
    class function Find(AController: TMyID3Controller; const AEmailAddress: AnsiString): TJvID3PopularimeterFrame; overload;
    class function FindOrCreate(AController: TMyID3Controller): TJvID3PopularimeterFrame; overload;
    class function FindOrCreate(AController: TMyID3Controller; const AEmailAddress: AnsiString): TJvID3PopularimeterFrame; overload;
  published
  ...
  public
    ...
    class function Find(AController: TMyID3Controller): TJvID3PlayCounterFrame;
    class function FindOrCreate(AController: TMyID3Controller): TJvID3PlayCounterFrame;
  published
    property Counter: Cardinal read FCounter write SetCounter;
  end;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AOwnerID: AnsiString): TJvID3AudioEncryptionFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AOwnerID: AnsiString): TJvID3AudioEncryptionFrame;
  published
  ...
  public
    ...
    class function Find(AController: TMyID3Controller): TJvID3TermsOfUseFrame;
    class function FindOrCreate(AController: TMyID3Controller): TJvID3TermsOfUseFrame;
  published
    property Language: AnsiString read FLanguage write SetLanguage;
    property Text: WideString read FText write SetText;
  end;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller): TJvID3OwnershipFrame;
    class function FindOrCreate(AController: TMyID3Controller): TJvID3OwnershipFrame;
  published
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AType: TJvID3PictureType): TJvID3PictureFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AType: TJvID3PictureType): TJvID3PictureFrame;
  published
    property MIMEType: AnsiString read FMIMEType write SetMIMEType;
  ...
  public
    function CheckFrame(const HandleError: TJvID3HandleError): Boolean; override;
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3SimpleListFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3SimpleListFrame;
  ...
  public
    function CheckFrame(const HandleError: TJvID3HandleError): Boolean; override;
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3NumberFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3NumberFrame;
  published
  ...
  public
    function CheckFrame(const HandleError: TJvID3HandleError): Boolean; override;
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3TimestampFrame;
  ...
  public
    function CheckFrame(const HandleError: TJvID3HandleError): Boolean; override;
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3TextFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3TextFrame;
  published
    property Text;
  end;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3URLFrame;
    class function FindOrCreate(AController: TMyID3Controller; const AFrameID: TJvID3FrameID): TJvID3URLFrame;
  published
    property URL: AnsiString read FURL write SetURL;
  end;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const Index: Integer): TJvID3UserFrame;
    class function FindOrCreate(AController: TMyID3Controller; const Index: Integer): TJvID3UserFrame;
  published
    property Description: WideString read FDescription write SetDescription;
  ...
  public
    ...
    class function Find(AController: TMyID3Controller; const Index: Integer): TJvID3URLUserFrame;
    class function FindOrCreate(AController: TMyID3Controller; const Index: Integer): TJvID3URLUserFrame;
  published
    property Description: WideString read FDescription write SetDescription;
    property URL: AnsiString read FURL write SetURL;
  end;
...
{  TJvID3FileInfo = class(TPersistent)
  ...
  TMyID3ControllerDesigner = class(TObject)
  private
    FController: TMyID3Controller;
  public
    constructor Create(Controller: TMyID3Controller);
    destructor Destroy; override;
  ...
  TMyID3ControllerState = (icsReading, icsWriting, icsUsingTempStream);
  TMyID3ControllerStates = set of TMyID3ControllerState;

  TMyID3Controller = class(TJvComponent)
  private
    FState: TMyID3ControllerStates;
...
//    FFileInfo: TJvID3FileInfo;
    ...
    FActive: Boolean;
//    FFileName: TFileName;
    FDesigner: TMyID3ControllerDesigner;
    FModified: Boolean;
    FOptions: TMyID3ControllerOptions;
...
//    property FileInfo: TJvID3FileInfo read FFileInfo;
    ...
    property Options: TMyID3ControllerOptions read FOptions write FOptions default [coAutoCorrect,
      coRemoveEmptyFrames];
  ...
  public
    ...
    procedure RemoveFromStream(const AStream: TStream);
...
//    function CopyFromID3v1(const DoOverwrite: Boolean = True): Boolean;
    ...
    property Designer: TMyID3ControllerDesigner read FDesigner;
    ...
    // Added methods for MEXP:
    function GetText(const AFrameID: TJvID3FrameID): WideString;
...
function CreateUniqueName(AController: TMyID3Controller; const FrameName: AnsiString;
...
function GenerateName(Controller: TMyID3Controller; FrameName: AnsiString;
...
var
  ...
  S: WideString;
  EOS: Boolean;
  ContentPtr, ContentEndPtr: PWideChar;
begin
  ContentPtr := PWideChar(Content);
  ContentEndPtr := ContentPtr + Length(Content);
  ...
  try
    ...
    repeat
      ...
      // EOS := Tail^ = WideNull;   won't work when Seperator = WideNull
      EOS :=  Tail >= ContentEndPtr;
...
procedure MoveData(data: TStream; offset: integer);
...
var
  buffSize, transfer, floor, position: Integer;
...
begin
    ...
    begin	// make file bigger
      ...
      floor := data.Size;
      while data.Position > 0 do
      begin
      	transfer := min(data.Position, SizeOf(buffer));
        data.Seek(-transfer, soFromCurrent);
        position := data.Position;
        buffSize := data.Read(buffer, transfer);
        data.Position := floor - buffSize;
        floor := data.Position;
        data.Write(buffer, buffSize);
    ...
    begin	//make file smaller
      ...
      begin
      	transfer := min(data.Size - data.Position, SizeOf(buffer));
        buffSize := data.Read(buffer, transfer);
        position := data.Position;
        data.Position := floor;
        data.Write(buffer, buffSize);
...
class function TJvID3AudioEncryptionFrame.CanAddFrame(
  AController: TMyID3Controller; AFrameID: TJvID3FrameID): Boolean;
begin
...
class function TJvID3AudioEncryptionFrame.Find(AController: TMyID3Controller;
...
class function TJvID3AudioEncryptionFrame.FindOrCreate(AController: TMyID3Controller;
  const AOwnerID: AnsiString): TJvID3AudioEncryptionFrame;
begin
...
constructor TJvID3Base.Create(AController: TMyID3Controller);
begin
  inherited Create;
...
class function TJvID3BinaryFrame.CanAddFrame(AController: TMyID3Controller;
...
class function TJvID3BinaryFrame.Find(AController: TMyID3Controller;
...
class function TJvID3BinaryFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3BinaryFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3ContentFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may be more than one comment frame in each tag, but only one with
    the same language and content descriptor.
...
class function TJvID3ContentFrame.Find(AController: TMyID3Controller;
...
class function TJvID3ContentFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3ContentFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
constructor TMyID3Controller.Create(AOwner: TComponent);
begin
...
destructor TMyID3Controller.Destroy;
begin
  //SetActive(False);
  DoClose();
  FActive := false;
...
function TMyID3Controller.AddFrame(const AFrameID: TJvID3FrameID): TJvID3Frame;
var
...
procedure TMyID3Controller.ApplyUnsynchronisationSchemeOnCurrentStream;
var
...
procedure TMyID3Controller.BeginReading;
begin
  if FState <> [] then
...
procedure TMyID3Controller.BeginUpdate;
begin
  Inc(FUpdateCount);
end;

procedure TMyID3Controller.BeginUseTempStream;
begin
  if icsUsingTempStream in FState then
...
procedure TMyID3Controller.BeginWriting;
begin
  if FState <> [] then
    ID3Error(RsEAlreadyReadingWriting, Self);
...
function TMyID3Controller.CanAddFrame(const AFrameID: TJvID3FrameID): Boolean;
var
  FrameClass: TJvID3FrameClass;
begin
...
procedure TMyID3Controller.ChangeToVersion(const ANewVersion: TJvID3Version);
begin
...
procedure TMyID3Controller.CheckFrameClass(FrameClass: TJvID3FrameClass;
...
procedure TMyID3Controller.Close;
begin
  //SetActive(False);
  DoClose();
end;

// TODO: This shoule be implemented with stream
//procedure TMyID3Controller.Commit;
//const
...
//function TMyID3Controller.CopyFromID3v1(const DoOverwrite: Boolean): Boolean;
//var
//  ID3v1Ctrl: TJvID3v1;
//begin
//  if not Active then
...
procedure TMyID3Controller.CopyFromID3v1Ctrl(AID3v1: TJvID3v1;
...
//function TMyID3Controller.CopyToID3v1(const DoOverwrite: Boolean): Boolean;
//var
//  ID3v1Ctrl: TJvID3v1;
//begin
//  if not Active then
...
procedure TMyID3Controller.CopyToID3v1Ctrl(AID3v1: TJvID3v1;
  const DoOverwrite: Boolean);
var
  S: string;
  Frame: TJvID3Frame;
...
procedure TMyID3Controller.DoClose;
begin
...
//procedure TMyID3Controller.DoOpen;
//var
...
procedure TMyID3Controller.EndReading;
begin
  if not (icsReading in FState) then
...
procedure TMyID3Controller.EndUpdate;
begin
  Dec(FUpdateCount);
...
procedure TMyID3Controller.EndUseTempStream;
begin
...
procedure TMyID3Controller.EndWriting;
begin
...
procedure TMyID3Controller.EnsureExists(const FrameIDs: TJvID3FrameIDs);
var
...
// TODO: implement for stream
//procedure TMyID3Controller.Erase;
//var
//  SavedActive: Boolean;
//begin
//  SavedActive := Active;
...
function TMyID3Controller.FindFirstFrame(const AFrameID: TJvID3FrameID;
  var Frame: TJvID3Frame): Boolean;
begin
  Frame := nil;
...
function TMyID3Controller.FindNextFrame(const AFrameID: TJvID3FrameID;
...
class function TMyID3Controller.GetFrameClass(const FrameID: TJvID3FrameID): TJvID3FrameClass;
begin
...
function TMyID3Controller.GetFrameCount: Integer;
begin
  Result := Frames.Count;
end;

function TMyID3Controller.GetFrameCountFor(const AFrameID: TJvID3FrameID): Cardinal;
var
  I: Integer;
begin
  Result := 0;
...
function TMyID3Controller.GetReadVersion: TJvID3Version;
begin
...
function TMyID3Controller.GetTagSize: Cardinal;
begin
  if not Active then
    Result := 0
  else
...
function TMyID3Controller.GetTempStreamSize: Cardinal;
begin
  if not Assigned(FTempStream) then
    ID3Error(RsENoTempStream, Self);
...
function TMyID3Controller.GetVersion: TJvID3Version;
begin
  Result := MajorVersionToVersion(FHeader.MajorVersion);
end;

function TMyID3Controller.GetWriteVersion: TJvID3Version;
begin
...
function TMyID3Controller.HasFrame(const AFrameID: TJvID3FrameID): Boolean;
begin
  Result := Assigned(Frames.FindFrame(AFrameID));
end;

procedure TMyID3Controller.ID3Event(Event: TJvID3Event; Info: Integer);
begin
...
//procedure TMyID3Controller.Loaded;
//begin
//  inherited Loaded;
//  try
...
procedure TMyID3Controller.Reset;
begin
  BeginReading;
  try
    { Clear }
...
procedure TMyID3Controller.LoadFromStream(const AStream: TStream);
begin
  BeginReading;
  try
    { Clear }
...
//procedure TMyID3Controller.Open;
//begin
//  SetActive(True);
//end;

procedure TMyID3Controller.RegisterClient(Client: TObject;
...
procedure TMyID3Controller.RemoveUnsynchronisationSchemeToTempStream(const ASize: Integer);
begin
  if icsUsingTempStream in FState then
    ID3Error(RsEAlreadyUsingTempStream, Self);
...
{procedure TMyID3Controller.SaveToFile(const AFileName: string);
var
  PaddingSize: Integer;
...
procedure TMyID3Controller.SaveToStream(const AStream: TStream);
var
  PaddingSize: Integer;
  OldTagSizeInclHeader: Cardinal;
  NewTagSizeInclHeader: Cardinal;
...
begin
  ...
  try
    ...
    AStream.Position := 0;
    OldTagSizeInclHeader := GetTagSizeInclHeader(AStream);
    ...
    if NewTagSizeInclHeader > OldTagSizeInclHeader then
    begin
      MoveData(AStream, NewTagSizeInclHeader - OldTagSizeInclHeader);
    end;
...
procedure TMyID3Controller.RemoveFromStream(const AStream: TStream);
var
  OldTagSizeInclHeader: Cardinal;
begin
  BeginWriting;
  try
    ...
    if OldTagSizeInclHeader > 0 then
    begin
      MoveData(AStream, -OldTagSizeInclHeader)
    end;
  finally
    EndWriting;
  end;
...
procedure TMyID3Controller.SendActivateEvent(Activated: Boolean);
var
  I: Integer;
...
{procedure TMyID3Controller.SetActive(const Value: Boolean);
begin
...
procedure TMyID3Controller.SetExtendedHeader(const Value: TJvID3ExtendedHeader);
begin
  FExtendedHeader.Assign(Value);
end;

{procedure TMyID3Controller.SetFileName(const Value: TFileName);
var
  SavedActive: Boolean;
begin
...
procedure TMyID3Controller.SetHeader(const Value: TJvID3Header);
begin
  FHeader.Assign(Value);
end;

procedure TMyID3Controller.SetModified(Value: Boolean);
begin
  FModified := Value;
end;

procedure TMyID3Controller.SetReadEncodingAs(const Value: TJvID3ForceEncoding);
begin
...
procedure TMyID3Controller.SetReadVersionAs(const Value: TJvID3ForceVersion);
begin
...
procedure TMyID3Controller.SetVersion(NewVersion: TJvID3Version);
begin
...
procedure TMyID3Controller.SetWriteEncodingAs(const Value: TJvID3ForceEncoding);
begin
...
procedure TMyID3Controller.SetWriteVersionAs(const Value: TJvID3ForceVersion);
begin
...
procedure TMyID3Controller.UnRegisterClient(Client: TObject);
var
  Index: Integer;
begin
...
procedure TMyID3Controller.WriteTempStream;
var
  LTempStreamSize: Cardinal;
begin
  if not Assigned(FTempStream) then
...
//=== Extra methods for MEXP ////

function TMyID3Controller.GetText(const AFrameID: TJvID3FrameID): WideString;
var
//  textFrame: TJvID3TextFrame;
  frame: TJvID3Frame;
begin
  self.FindFirstFrame(AFrameId, frame);
  if Assigned(frame) then
  begin
    if frame is TJvID3CustomTextFrame then
    begin
      result := TJvID3CustomTextFrame(frame).Text;
      exit
    end
{    else if frame is TJvID3SimpleListFrame and (TJvID3SimpleListFrame(frame).List.Count > 0) then
    begin
      result := TJvID3SimpleListFrame(frame).List[0];
      exit
    end    }
  end;
//  textFrame := TJvId3TextFrame.Find(self, AFrameId);
//  if Assigned(textFrame) then
//    result := textFrame.Text
//  else
    result := '';
end;

//=== { TMyID3ControllerDesigner } ===========================================

constructor TMyID3ControllerDesigner.Create(Controller: TMyID3Controller);
begin
  inherited Create;
...
destructor TMyID3ControllerDesigner.Destroy;
begin
  FController.FDesigner := nil;
  inherited Destroy;
end;

procedure TMyID3ControllerDesigner.BeginDesign;
begin
  Controller.BeginUpdate;
end;

procedure TMyID3ControllerDesigner.EndDesign;
begin
  Controller.EndUpdate;
end;

procedure TMyID3ControllerDesigner.ID3Event(Event: TJvID3Event; Info: Integer);
begin
end;
...
class function TJvID3CustomTextFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  {  There may only be one text information frame of its kind in an tag }
...
class function TJvID3DoubleListFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may only be one "IPLS" frame in each tag. }
  Result :=
...
class function TJvID3DoubleListFrame.Find(AController: TMyID3Controller;
...
class function TJvID3DoubleListFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3DoubleListFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
begin
  ...
  begin
    ReadEncoding;
// TODO: Skal denne også være >= i stedeT?
...
// Removed for MEXP as it is not needed
...
class function TJvID3Frame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  if TMyID3Controller.GetFrameClass(AFrameID) <> ClassType then
    ErrorFmt(RsEID3FrameIDNotSupported, [ID3_FrameIDToString(AFrameID)]);
end;
...
begin
  ...
  if TMyID3Controller.GetFrameClass(LFrameID) <> ClassType then
    ErrorFmt(RsEID3FrameIDStrNotSupported, [S]);
end;
...
function TJvID3Frame.Read: Boolean;
var
  LFrameSize: Integer;
begin
...
procedure TJvID3Frame.SetController(const AController: TMyID3Controller);
begin
...
begin
  if (FController <> nil) and not (icsReading in Controller.FState) and not (csDestroying in FController.ComponentState) then
...
class function TJvID3GeneralObjFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may be more than one "GEOB" frame in each tag, but only one with the
    same content descriptor. }
...
class function TJvID3GeneralObjFrame.Find(AController: TMyID3Controller;
...
class function TJvID3GeneralObjFrame.Find(AController: TMyID3Controller): TJvID3GeneralObjFrame;
var
  Frame: TJvID3Frame;
begin
  Result := nil;
...
class function TJvID3GeneralObjFrame.FindOrCreate(AController: TMyID3Controller;
  const AContentDescription: WideString): TJvID3GeneralObjFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3GeneralObjFrame.FindOrCreate(AController: TMyID3Controller): TJvID3GeneralObjFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3NumberFrame.Find(AController: TMyID3Controller;
...
class function TJvID3NumberFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3NumberFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3OwnershipFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may only be one 'OWNE' frame in a tag }
...
class function TJvID3OwnershipFrame.Find(AController: TMyID3Controller): TJvID3OwnershipFrame;
var
  Frame: TJvID3Frame;
begin
  Result := nil;
...
class function TJvID3OwnershipFrame.FindOrCreate(AController: TMyID3Controller): TJvID3OwnershipFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3PictureFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
...
class function TJvID3PictureFrame.Find(AController: TMyID3Controller;
...
class function TJvID3PictureFrame.FindOrCreate(AController: TMyID3Controller;
  const AType: TJvID3PictureType): TJvID3PictureFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3PlayCounterFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may only be one "PCNT" frame in each tag. }
  Result := not AController.HasFrame(AFrameID) or
...
class function TJvID3PlayCounterFrame.Find(AController: TMyID3Controller): TJvID3PlayCounterFrame;
var
  Frame: TJvID3Frame;
begin
  Result := nil;
...
class function TJvID3PlayCounterFrame.FindOrCreate(AController: TMyID3Controller): TJvID3PlayCounterFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3PopularimeterFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may be more than one "POPM" frame in each tag, but only one with the
    same email address. }
...
class function TJvID3PopularimeterFrame.Find(AController: TMyID3Controller): TJvID3PopularimeterFrame;
var
  Frame: TJvID3Frame;
begin
  Result := nil;
...
class function TJvID3PopularimeterFrame.Find(AController: TMyID3Controller;
...
class function TJvID3PopularimeterFrame.FindOrCreate(AController: TMyID3Controller): TJvID3PopularimeterFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3PopularimeterFrame.FindOrCreate(AController: TMyID3Controller;
  const AEmailAddress: AnsiString): TJvID3PopularimeterFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3SimpleListFrame.Find(AController: TMyID3Controller;
...
class function TJvID3SimpleListFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3SimpleListFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
begin
  ...
  begin
    ...
    { Set one separator less, the last line does not have a trailing
      separator }
    if not IsNullSeparator and (List.Count > 0) then
      Dec(CharLength);
  end;
...
begin
  ...
  begin
    ...
    begin
      ReadEncoding;
      // while BytesTillEndOfFrame > cMinBytes[Encoding] do
      // changed so we can read values of 1 char (Anders)
      while BytesTillEndOfFrame >= cMinBytes[Encoding] do
      begin
        ReadStringEnc(S);
        List.Add(S);
...
class function TJvID3TermsOfUseFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
  { There may only be one 'USER' frame in a tag}
...
class function TJvID3TermsOfUseFrame.Find(AController: TMyID3Controller): TJvID3TermsOfUseFrame;
var
  Frame: TJvID3Frame;
begin
  Result := nil;
...
class function TJvID3TermsOfUseFrame.FindOrCreate(AController: TMyID3Controller): TJvID3TermsOfUseFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3TextFrame.Find(AController: TMyID3Controller;
...
class function TJvID3TextFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3TextFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3TimestampFrame.Find(AController: TMyID3Controller;
...
class function TJvID3TimestampFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3TimestampFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3URLFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
...
class function TJvID3URLFrame.Find(AController: TMyID3Controller;
...
class function TJvID3URLFrame.FindOrCreate(AController: TMyID3Controller;
  const AFrameID: TJvID3FrameID): TJvID3URLFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3URLUserFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
...
class function TJvID3URLUserFrame.Find(AController: TMyID3Controller;
...
class function TJvID3URLUserFrame.FindOrCreate(AController: TMyID3Controller;
  const Index: Integer): TJvID3URLUserFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
...
class function TJvID3UserFrame.CanAddFrame(AController: TMyID3Controller;
  AFrameID: TJvID3FrameID): Boolean;
begin
...
class function TJvID3UserFrame.Find(AController: TMyID3Controller;
...
class function TJvID3UserFrame.FindOrCreate(AController: TMyID3Controller;
  const Index: Integer): TJvID3UserFrame;
begin
  if not Assigned(AController) then
    ID3Error(RsEID3NoController);
